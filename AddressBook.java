...
public class AddressBook {
    ...
    public static void main(String args[])throws Exception {
        ...
        meniu();
        //list();
        /*create("1000000000","Paquita del Barrio");
        list();
        delete("1000000000");
        list();*/
      // meniu();
    ...
    public static void load()throws Exception{
        ...
        File listCntArch = new File("C:\\Dana\\Trabajos\\Computación Java\\AdressBook\\out\\production\\AdressBook\\contactos.csv");
    ...
    public static void save()throws IOException{
        ...
        escritor = new FileWriter("C:\\Dana\\Trabajos\\Computación Java\\AdressBook\\out\\production\\AdressBook\\contactos.csv");
    ...
    public static void meniu () throws IOException {
        ...
        System.out.println("_-_-_- Agenda de contactius -_-_-_");
